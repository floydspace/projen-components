...
export namespace NodePackageUtils {
   ...
   * @param {string[]} args - The arguments to append to the command string.
   * @returns {string} - The command string with appended arguments.
   */
   ...
   * @returns {boolean} - True if the project is a NodeProject, false otherwise.
   */
   ...
   * @param {NodePackageManager} defaultPackageManager - The default package manager to use if none is found.
   * @returns {NodePackageManager} - The Node package manager for the project.
   */
  ...
  export namespace command {
     ...
     *
     * @param {NodePackageManager} packageManager - The package manager to use.
     * @param {...string} args - The arguments to pass to the script.
     * @returns {string} - The command to run the script.
     */
     ...
     *
     * @param {NodePackageManager} packageManager - The package manager to use.
     * @param {...string} args - The arguments to pass to the projen command.
     * @returns {string} - The command to execute projen or a projen task.
     */
     ...
     *
     * @param {NodePackageManager} packageManager - The package manager to use.
     * @param {...string} args - The arguments to pass to the shell command.
     * @returns {string} - The command to execute the shell command.
     */
     ...
     * @returns {string} - The command to run the package.
     */
     ...
     *
     * @param {NodePackageManager} packageManager - The package manager to use.
     * @param {...string} args - The arguments to pass to the install command.
     * @returns {string} - The command to install the package.
     */
     ...
     * @returns {string} - The bash command to execute the given command.
     */
    export function bin(
      packageManager: NodePackageManager,
      _cmd: string
